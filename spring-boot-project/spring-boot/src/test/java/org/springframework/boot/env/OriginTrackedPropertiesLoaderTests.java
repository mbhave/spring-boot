...
class OriginTrackedPropertiesLoaderTests {
	...
	private List<Map<String, OriginTrackedValue>> properties;
	...
	void compareToJavaProperties() throws Exception {
		...
		new OriginTrackedPropertiesLoader(this.resource).load(false).get(0)
	...
	void getSimpleProperty() {
		OriginTrackedValue value = this.properties.get(0).get("test");
	...
	void getSimplePropertyWithColonSeparator() {
		OriginTrackedValue value = this.properties.get(0).get("test-colon-separator");
	...
	void getPropertyWithSeparatorSurroundedBySpaces() {
		OriginTrackedValue value = this.properties.get(0).get("blah");
	...
	void getUnicodeProperty() {
		OriginTrackedValue value = this.properties.get(0).get("test-unicode");
	...
	void getEscapedProperty() {
		OriginTrackedValue value = this.properties.get(0).get("test=property");
	...
	void getPropertyWithTab() {
		OriginTrackedValue value = this.properties.get(0).get("test-tab-property");
	...
	void getPropertyWithBang() {
		OriginTrackedValue value = this.properties.get(0).get("test-bang-property");
	...
	void getPropertyWithValueComment() {
		OriginTrackedValue value = this.properties.get(0).get("test-property-value-comment");
	...
	void getPropertyWithMultilineImmediateBang() {
		OriginTrackedValue value = this.properties.get(0).get("test-multiline-immediate-bang");
		assertThat(getValue(value)).isEqualTo("!foo");
	...
	void getPropertyWithCarriageReturn() {
		OriginTrackedValue value = this.properties.get(0).get("test-return-property");
	...
	void getPropertyWithNewLine() {
		OriginTrackedValue value = this.properties.get(0).get("test-newline-property");
		assertThat(getValue(value)).isEqualTo("foo\nbar");
	...
	void getPropertyWithFormFeed() {
		OriginTrackedValue value = this.properties.get(0).get("test-form-feed-property");
	...
	void getPropertyWithWhiteSpace() {
		OriginTrackedValue value = this.properties.get(0).get("test-whitespace-property");
		assertThat(getValue(value)).isEqualTo("foo   bar");
	...
	void getCommentedOutPropertyShouldBeNull() {
		assertThat(this.properties.get(0).get("commented-property")).isNull();
		assertThat(this.properties.get(0).get("#commented-property")).isNull();
		assertThat(this.properties.get(0).get("commented-two")).isNull();
		assertThat(this.properties.get(0).get("!commented-two")).isNull();
	}

	@Test
	void getMultiline() {
		OriginTrackedValue value = this.properties.get(0).get("test-multiline");
	...
	void getImmediateMultiline() {
		OriginTrackedValue value = this.properties.get(0).get("test-multiline-immediate");
		assertThat(getValue(value)).isEqualTo("foo");
	...
	void getPropertyWithWhitespaceAfterKey() {
		OriginTrackedValue value = this.properties.get(0).get("bar");
	...
	void getPropertyWithSpaceSeparator() {
		OriginTrackedValue value = this.properties.get(0).get("hello");
	...
	void getPropertyWithBackslashEscaped() {
		OriginTrackedValue value = this.properties.get(0).get("proper\\ty");
	...
	void getPropertyWithEmptyValue() {
		OriginTrackedValue value = this.properties.get(0).get("foo");
	...
	void getPropertyWithBackslashEscapedInValue() {
		OriginTrackedValue value = this.properties.get(0).get("bat");
	...
	void getPropertyWithSeparatorInValue() {
		OriginTrackedValue value = this.properties.get(0).get("bling");
	...
	void getPropertyWithISO88591Character() {
		OriginTrackedValue value = this.properties.get(0).get("test-iso8859-1-chars");
		assertThat(getValue(value)).isEqualTo("æ×ÈÅÞßáñÀÿ");
	}

	@Test
	void getPropertyWithTrailingSpace() {
		OriginTrackedValue value = this.properties.get(0).get("test-with-trailing-space");
