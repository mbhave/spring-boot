...
/**
 * Tests for {@link IgnoreTopLevelErrorsBindHandler}.
 *
 * @author Madhura Bhave
 */
public class IgnoreTopLevelErrorsBindHandlerTests {
	...
	public void bindWhenTopLevelContextAndExceptionIgnorableShouldNotFail() {
		this.binder.bind("example", Bindable.of(Example.class), new IgnoreTopLevelErrorsBindHandler());
	}
