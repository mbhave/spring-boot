...
import org.springframework.boot.context.properties.bind.handler.IgnoreTopLevelErrorsBindHandler;
...
class ConfigurationPropertiesBinder {
	...
	private BindHandler getBindHandler(ConfigurationProperties annotation,
		...
		BindHandler handler = new IgnoreTopLevelErrorsBindHandler();
