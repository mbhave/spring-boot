...
public class ConfigurationPropertiesBoundPropertiesHolder implements BoundPropertiesHolder {
	...
	private Map<ConfigurationPropertyName, ConfigurationProperty> propertiesMap = new LinkedHashMap<>();
	...
	public void recordBinding(ConfigurationProperty configurationProperty) {
		...
		this.propertiesMap.put(configurationProperty.getName(), configurationProperty);
	}

	public Map<ConfigurationPropertyName, ConfigurationProperty> getPropertiesMap() {
