...
public class MvcEndpointRequestIntegrationTests
	...
	public MvcEndpointRequestIntegrationTests() {
		super(contextRunner);
	}

	private static WebApplicationContextRunner contextRunner = new WebApplicationContextRunner(
	...
	public void toEndpointWhenServletPathSetShouldMatch() {
		contextRunner.withPropertyValues("spring.mvc.servlet.path=/admin")
				.run((context) -> {
