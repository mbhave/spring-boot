...
public final class EndpointRequest {
	...
	public static final class LinksRequestMatcher
		...
		@Override
		protected void initialized(Supplier<WebApplicationContext> webApplicationContext) {
			WebEndpointProperties properties = webApplicationContext.get().getBean(WebEndpointProperties.class);
			DispatcherServletPathProvider pathProvider = webApplicationContext.get().getBean(DispatcherServletPathProvider.class);
