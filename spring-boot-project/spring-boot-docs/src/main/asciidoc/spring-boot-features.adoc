...
----
	...
	spring.security.oauth2.client.registration.authorization-code.my-client-1.redirect-uri-template=http://my-redirect-uri.com
	...
	spring.security.oauth2.client.registration.authorization-code.my-client-2.redirect-uri-template=http://my-redirect-uri.com
