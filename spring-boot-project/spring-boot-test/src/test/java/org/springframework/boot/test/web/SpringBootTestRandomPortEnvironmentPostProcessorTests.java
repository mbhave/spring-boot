...
public class SpringBootTestRandomPortEnvironmentPostProcessorTests {
	...
	@Test
	public void postProcessWhenServerAndManagementPortIsZeroAndSpecifiedInTest() {
	...
	@Test
	public void postProcessWhenServerAndManagementPortIsNonZeroAndSpecifiedInTest() {
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortIsSpecifiedInTest() {
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortIsNull() {
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortIsNotNullAndSameOutsideTests() {
		addTestPropertySource("0", null);
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortIsNotNullAndDefaultSameOutsideTests() {
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortIsNotNullAndDifferentOutsideTests() {
		addTestPropertySource("0", null);
		Map<String, Object> other = new HashMap<>();
		other.put("management.server.port", "8081");
		MapPropertySource otherSource = new MapPropertySource("other", other);
	...
	@Test
	public void postProcessWhenServerPortIsZeroAndManagementPortMinusOne() {
		addTestPropertySource("0", null);
		Map<String, Object> other = new HashMap<>();
