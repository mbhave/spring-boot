 ...
 */
public class LibraryStrategiesTests {
	...
	private LibraryStrategies createStrategies() {
		Map<String, LibraryStrategy> strategies = new LinkedHashMap<>();
		strategies.put("layer-1", mockLibraryStrategy("test-layer-1"));
		strategies.put("layer-2", mockLibraryStrategy("test-layer-2"));
