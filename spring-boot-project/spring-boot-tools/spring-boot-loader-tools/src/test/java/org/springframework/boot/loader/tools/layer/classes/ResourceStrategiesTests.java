...
class ResourceStrategiesTests {
	...
	private ResourceStrategies createStrategies() {
		List<ResourceStrategy> strategies = new ArrayList<>();
		strategies.add(mockResourceStrategy("test-layer-1"));
		strategies.add(mockResourceStrategy("test-layer-2"));
