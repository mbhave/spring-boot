...
public class AuthenticationManagerConfigurationTests {
	...
	@Test
	public void userDetailsServiceWhenClientRegistrationRepositoryBeanPresentAndCreateModeNotSpecified() {
		this.contextRunner
	...
	@Test
	public void userDetailsServiceWhenClientRegistrationRepositoryBeanPresentAndDefaultCreateMode() {
		this.contextRunner
				.withUserConfiguration(TestConfigWithClientRegistrationRepository.class,
						AuthenticationManagerConfiguration.class)
				.withPropertyValues("spring.security.user.create-mode=DEFAULT")
				.run(((context) -> assertThat(context).doesNotHaveBean(InMemoryUserDetailsManager.class)));
	}

	@Test
	public void userDetailsServiceWhenDefaultCreateMode() {
		this.contextRunner
				.withUserConfiguration(TestSecurityConfiguration.class,
						AuthenticationManagerConfiguration.class)
				.withPropertyValues("spring.security.user.create-mode=DEFAULT")
				.run(((context) -> assertThat(context.getBean(InMemoryUserDetailsManager.class)).isNotNull()));
	}

	@Test
	public void userDetailsServiceWhenClientRegistrationRepositoryBeanPresentAndCreateModeAlwaysOn() {
		this.contextRunner
				.withUserConfiguration(TestConfigWithClientRegistrationRepository.class,
						AuthenticationManagerConfiguration.class)
				.withPropertyValues("spring.security.user.create-mode=ALWAYS_ON")
				.run(((context) -> assertThat(context.getBean(InMemoryUserDetailsManager.class)).isNotNull()));
	}

	@Test
	public void userDetailsServiceWhenCreateModeAlwaysOff() {
		this.contextRunner
				.withUserConfiguration(TestSecurityConfiguration.class,
						AuthenticationManagerConfiguration.class)
				.withPropertyValues("spring.security.user.create-mode=ALWAYS_OFF")
				.run(((context) -> assertThat(context).doesNotHaveBean(InMemoryUserDetailsManager.class)));
	}
