...
public class WebTestClientAutoConfiguration {
	...
	public WebTestClient webTestClient(ApplicationContext applicationContext,
			...
			List<MockServerConfigurerProvider> configurerProviders) {
		WebTestClient.MockServerSpec<?> mockServerSpec = WebTestClient
				.bindToApplicationContext(applicationContext);
		for (MockServerConfigurerProvider configurerProvider : configurerProviders) {
			mockServerSpec.apply(configurerProvider.get());
		}
