...
class WebTestClientSecurityConfiguration {
	...
	@Bean
	public SecurityMockServerConfigurerProvider securityConfigurer() {
		return new SecurityMockServerConfigurerProvider();
	}

	class SecurityMockServerConfigurerProvider implements MockServerConfigurerProvider {
