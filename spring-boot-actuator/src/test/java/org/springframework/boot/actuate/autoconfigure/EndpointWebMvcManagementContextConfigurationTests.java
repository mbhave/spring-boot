...
public class EndpointWebMvcManagementContextConfigurationTests {
	...
	public void endpointHandlerMapping() throws Exception {
		...
		Object isSecure = ReflectionTestUtils.getField(securityInterceptor, "isSecure");
		List<String> roles = (List<String>) ReflectionTestUtils.getField(securityInterceptor, "roles");
		assertThat(isSecure).isEqualTo(false);
