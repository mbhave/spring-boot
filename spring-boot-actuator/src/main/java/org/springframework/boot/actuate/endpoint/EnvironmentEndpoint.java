...
public class EnvironmentEndpoint extends AbstractEndpoint<Map<String, Object>> {
	...
	public PropertyResolver getResolver() {
		PropertySanitizingPropertyResolver resolver = new PropertySanitizingPropertyResolver(getPropertySources(), this.sanitizer);
	 ...
	 * @author Madhura Bhave
	 */
	private class PropertySanitizingPropertyResolver extends PropertySourcesPropertyResolver {
		 ...
		 */
		PropertySanitizingPropertyResolver(PropertySources
